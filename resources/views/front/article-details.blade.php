					...
					<div class="container">
						<div class="row">
							<div class="col-md-12 align-self-center p-static order-2 text-center">
								<h1 class="text-dark font-weight-bold text-8">Article-Details</h1>
								...
								<article class="post post-large">
									<div class="post-image">
										<a href="blog-post.html">
											<img src="{{ asset($articles->image) }}" class="img-fluid img-thumbnail img-thumbnail-no-borders rounded-0" alt="" />
										</a>
									</div>
                                    <br>
									<div class="post-content">

										<h2 class="font-weight-semibold text-6 line-height-3 mb-3"><a href="blog-post.html">{{$articles->article_title}}</a></h2>
										<p>{{ $articles->article_description}}</p>

										<div class="post-meta">
											<span><i class="far fa-user"></i> By <a href="#"></a>{{ $articles->name}} </span>
