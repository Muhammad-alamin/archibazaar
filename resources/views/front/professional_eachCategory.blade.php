...
<html>
	...
	<body data-plugin-page-transition>
		...
		<div class="body">
            ...
            <section class="section section-background section-height-4" data-plugin-parallax data-plugin-options="{'speed': 1.5}" data-image-src="front/assets/img/demos/business-consulting/slides/slider3.jpg" style="height: 400px">
                <div class="container">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 col-xl-12" style="margin-top: 100px;">
                                <h1 class="text-color-light custom-font-size-1 text-center">Interior Designers</h1>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div role="main" class="main shop pt-4">
                <div class="container">
                    <h2 class="text-center"> Interior Designers</h2>
				</div>

				<div class="container">
					<div class="masonry-loader masonry-loader-loaded">
						<div class="row products product-thumb-info-list" data-plugin-masonry="" data-plugin-options="{'layoutMode': 'fitRows'}" style="position: relative; height: 1359.25px;">

							<div class="col-12 col-sm-6 col-lg-3" style="position: absolute; left: 0px; top: 0px;">
								<div class="card">
                                    <img class="card-img-top" src="front/assets/img/demos/business-consulting/slides/image5.jpg" alt="Card Image">
