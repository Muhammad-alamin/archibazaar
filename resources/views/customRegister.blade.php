				...
				<div class="container py-4">
					...
					<div class="row justify-content-center">
						<div class="col-md-12 col-lg-5 mb-5 mb-lg-0">
							<h2 class="font-weight-bold text-5 mb-0">Sign up</h2>
							<form method="POST" action="{{ route('user.store') }}" id="frmSignIn" class="needs-validation">
                                @csrf
								<div class="row">
                                ...
                                <div class="row">
									<div class="form-group col">
                                        ...
                                        <div class="custom-select-1">
							                <select id="role" class="form-control text-3 h-auto py-2 " name="role" >
							                    <option value="" disabled selected>Select Role</option>
                                                <option value="Architect" >Architect</option>
							                    <option value="Build Contractor" >Build Contractor</option>
							                    <option value="project Manager" n>Project Manager</option>
								...
								<div class="row">
									<div class="form-group col">
										<button type="submit" class="btn btn-dark btn-modern w-100 text-uppercase rounded-0 font-weight-bold text-3 py-3" data-loading-text="Loading...">Submit</button>
										<div class="divider">
											<span class="bg-light px-4 position-absolute left-50pct top-50pct transform3dxy-n50">or</span>
										</div>
										<a href="{{ route('login') }}" class="btn btn-primary-scale-2 btn-modern w-100 text-transform-none rounded-0 font-weight-bold align-items-center d-inline-flex justify-content-center text-3 py-3" data-loading-text="Loading...">Sign In</a>
									</div>
								</div>
							</form>
						</div>
