					...
					<div class="row">
						<div class="col-lg-8">
                                ...
                                <header class="card-header">
                                    ...
                                    <h2 class="card-title">Proile Info</h2>
                                </header>
                                <div class="card-body">
							        <form role="form" method="POST" action="{{ route('admin.profile.update', encrypt(auth()->user()->id)) }}" class="needs-validation">
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-3 col-form-label form-control-label line-height-9 pt-2 text-2 ">New password</label>
                                            <div class="col-lg-9">
