...
@section('content')
			<div role="main" class="main">
				<section role="main" class="content-body card-margin">
					...
					<div class="row">
						<div class="col-lg-8">
							<form id="form1" action="{{ route('admin.projects.update', encrypt($project->id)) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                @csrf
								<section class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @foreach($professionals as $key=>$professional)
                                            <option hidden @if(old('professional_name',isset($project)?$project->professional_name:null)  == $professional->name) selected @endif value="{{$professional->name}}">{{$professional->name}}</option>
                                        @endforeach
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" multiple class="custom-file-input" class="custom-file-input" type="file" name="multiple_image[]" id="multiple_image">
                                                 @php($images = json_decode($project->multiple_image))
                                                 @if(isset($images))
