			...
			<div role="main" class="main">
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12 align-self-center p-static order-2 text-center">
								<h1 class="font-weight-bold text-dark">Project Edit</h1>
							</div>
						</div>
					</div>
				</section>
				...
				<div class="container pt-3 pb-2">
					...
					<div class="row pt-2">
						...
						<div class="col-lg-9">
							<form role="form" action="{{ route('professional.project.update',encrypt($project->id)) }}" method="post" class="needs-validation" enctype="multipart/form-data">
