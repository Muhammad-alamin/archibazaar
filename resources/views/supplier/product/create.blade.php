			...
			<div role="main" class="main">
				...
				<div class="container pt-3 pb-2">
					...
					<div class="row pt-2">
						...
						<div class="col-lg-9">
							<form role="form" method="POST" action="{{ route('product.store') }}" class="needs-validation" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label line-height-9 pt-2 text-2 required">Multiple images</label>
							        <div class="col-lg-9">
                                        <div class="custom-file">
                                            <input type="file" name="multiple_image[]" id="images" multiple class="custom-file-input">
