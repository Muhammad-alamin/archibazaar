				...
				<div class="container py-4">
					...
					<div class="row justify-content-center">
						<div class="col-md-12 col-lg-5 mb-5 mb-lg-0">
							...
							<form method="POST" action="{{ route('register') }}" id="frmSignIn" class="needs-validation">
                                @csrf
								<div class="row">
                                ...
                                <div class="row">
									<div class="form-group col">
                                        <label class="form-label text-color-dark text-3">Phone <span class="text-color-danger">*</span></label>
                                ...
                                <div class="row">
									<div class="form-group col">
                                        <label class="form-label text-color-dark text-3">Role <span class="text-color-danger">*</span></label>
                                        <div class="custom-select-1">
							                <select id="user_time_zone" class="form-control text-3 h-auto py-2 valid" name="role" size="0" aria-invalid="false">
							                    <option value="" disabled selected>Select Role</option>
                                                <option value="Architect" name="Architect">Architect</option>
							                    <option value="Build Contractor" name="Build Contractor">Build Contractor</option>
							                    <option value="project Manager" name="project Manager">Project Manager</option>
							                    <option value="supplier" name="supplier">Supplier</option>
							                    <option value="manufacturer" name="manufacturer">Manufacturer</option>
							                    <option value="owner" name="owner">Owner/Operator</option>
							                </select>
							            </div>
                                        @error('role')
                                            <span class="invalid-feedback" role="alert">
								...
								<div class="row">
									<div class="form-group col">
										...
										<a href="{{ route('register') }}" class="btn btn-primary-scale-2 btn-modern w-100 text-transform-none rounded-0 font-weight-bold align-items-center d-inline-flex justify-content-center text-3 py-3" data-loading-text="Loading..."> Create an account</a>
									</div>
								</div>
							</form>
						</div>
